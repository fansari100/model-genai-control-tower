...
const seedModels: Model[] = [
  ...
  { id: "2", name: "Claude Opus 4.6", version: "4.6", model_type: "llm", deployment: "vendor_api", status: "under_review", risk_tier: "tier_2_high", owner: "AI Platform Team", vendor_id: "v-anthropic", provider_model_id: "claude-opus-4-6", created_at: "2025-01-10T00:00:00Z" },
  { id: "3", name: "Gemini 3 Pro", version: "3.0", model_type: "llm", deployment: "vendor_api", status: "approved", risk_tier: "tier_2_high", owner: "AI Platform Team", vendor_id: "v-google", provider_model_id: "gemini-3.0-pro", created_at: "2026-01-25T00:00:00Z" },
