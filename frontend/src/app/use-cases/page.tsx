...
const seedUseCases: GenAIUseCase[] = [
  ...
  { id: "uc6", name: "Portfolio Risk Commentary Generator", version: "1.0.0", category: "content_generation", status: "testing", risk_rating: "medium", data_classification: "confidential", client_facing: true, uses_agents: false, uses_rag: false, uses_tools: false, uses_memory: false, requires_human_in_loop: true, owner: "Risk Analytics", business_unit: "Wealth Management", required_test_suites: ["quality_correctness", "safety_security", "operational_controls"], created_at: "2025-12-01T00:00:00Z" },
  { id: "uc7", name: "Regulatory Change Monitor", version: "0.8.0", category: "data_extraction", status: "intake", risk_rating: "medium", data_classification: "internal", client_facing: false, uses_agents: false, uses_rag: true, uses_tools: false, uses_memory: false, requires_human_in_loop: false, owner: "Compliance", business_unit: "Compliance", created_at: "2026-01-05T00:00:00Z" },
  { id: "uc8", name: "Compliance Pre-Screen", version: "1.0.0", category: "classification", status: "approved", risk_rating: "high", data_classification: "pii", client_facing: false, uses_agents: false, uses_rag: false, uses_tools: false, uses_memory: false, requires_human_in_loop: true, owner: "Compliance", business_unit: "Compliance", required_test_suites: ["quality_correctness", "safety_security", "red_team_promptfoo", "vulnerability_garak", "operational_controls"], created_at: "2025-10-15T00:00:00Z" },
];
